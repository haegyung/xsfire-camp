...
[Submit a PR](https://github.com/theprometheusxyz/xsfire-camp/pulls) to add yours!

#### Installation

Install the adapter from the latest release for your architecture and OS: https://github.com/theprometheusxyz/xsfire-camp/releases
